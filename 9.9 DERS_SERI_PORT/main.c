...
void timerkesmefonksiyonu()
{
    ...
    // Zamaný string formatýnda UART üzerinden gönder
    char buffer2[9]; // "HH:MM:SS" için yer ayýr
    format_time(buffer2, saat, dakika, saniye); // Formatlanmýþ zamaný oluþtur
    int i;
    for (i = 0; i < 8; i++) {
...
void serikesme()
{
    ...
    buffer[8] = '\0'; // String'i sonlandýr

    // "HH:MM:SS" formatýndaki string'i parçala
